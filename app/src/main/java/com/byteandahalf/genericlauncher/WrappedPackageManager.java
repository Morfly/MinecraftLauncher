...
/**
 * A mock {@link PackageManager} class.  All methods are functional.
...
@Override
    ...
    @Override
    public CharSequence getUserBadgedLabel(CharSequence label, UserHandle user){        return wrapped.getUserBadgedLabel(label,user);
    }
